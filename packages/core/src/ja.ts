...
export const ja = {
  ...
  'concept.safeSearchOff.help': 'セーフサーチ（既定でオン）を解除して検索します（Googleのみ対応）',
  ...
  'concept.sortOrder.oldest': '投稿の古い順',
  'concept.sortOrder.updated': '更新の新しい順',
  'concept.sortOrder.updatedOld': '更新の古い順',
  ...
  'concept.resolution.none': '指定なし',
  'concept.resolution.large': '3,000px×3,000px以上',
  'concept.resolution.medium': '1,000px×1,000px〜2,999px×2,999px',
  'concept.resolution.small': '999px×999px以下',
  'concept.resolution.help': 'pixivで、作品画像の解像度で絞り込みます',
  'concept.aspectRatio.label': '縦横比',
  'concept.aspectRatio.none': '指定なし',
  'concept.aspectRatio.landscape': '横長',
  'concept.aspectRatio.portrait': '縦長',
  'concept.aspectRatio.square': '正方形',
  'concept.aspectRatio.help': 'pixivで、作品画像の縦横比で絞り込みます',
  'concept.productionTool.label': '制作ツール',
  'concept.productionTool.none': '指定なし',
  'concept.productionTool.help':
    'pixivで、投稿者が申告した制作ツール・画材で絞り込みます（デジタルソフト・アナログ画材の双方に対応）',
  ...
  'concept.productionTool.お絵描き掲示板': 'お絵描き掲示板',
  'concept.productionTool.AzPainter': 'AzPainter',
  'concept.productionTool.CGillust': 'CGillust',
  'concept.productionTool.お絵描きチャット': 'お絵描きチャット',
  'concept.productionTool.手書きブログ': '手書きブログ',
  ...
  'concept.productionTool.こくばん.in': 'こくばん.in',
  'concept.productionTool.RETAS STUDIO': 'RETAS STUDIO',
  'concept.productionTool.えもふり・E-mote': 'えもふり・E-mote',
  'concept.productionTool.4thPaint': '4thPaint',
  'concept.productionTool.コミラボ': 'コミラボ',
  ...
  'concept.productionTool.シャープペンシル': 'シャープペンシル',
  'concept.productionTool.鉛筆': '鉛筆',
  'concept.productionTool.ボールペン': 'ボールペン',
  'concept.productionTool.ミリペン': 'ミリペン',
  'concept.productionTool.色鉛筆': '色鉛筆',
  'concept.productionTool.コピック': 'コピック',
  'concept.productionTool.つけペン': 'つけペン',
  'concept.productionTool.透明水彩': '透明水彩',
  'concept.productionTool.筆': '筆',
  'concept.productionTool.筆ペン': '筆ペン',
  'concept.productionTool.サインペン': 'サインペン',
  'concept.productionTool.マジック': 'マジック',
  'concept.productionTool.水彩色鉛筆': '水彩色鉛筆',
  'concept.productionTool.絵の具': '絵の具',
  'concept.productionTool.アクリル': 'アクリル',
  'concept.productionTool.万年筆': '万年筆',
  'concept.productionTool.パステル': 'パステル',
  'concept.productionTool.エアブラシ': 'エアブラシ',
  'concept.productionTool.カラーインク': 'カラーインク',
  'concept.productionTool.クレヨン': 'クレヨン',
  'concept.productionTool.油彩': '油彩',
  'concept.productionTool.クーピーペンシル': 'クーピーペンシル',
  'concept.productionTool.顔彩': '顔彩',
  'concept.productionTool.クレパス': 'クレパス',
