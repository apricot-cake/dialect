import type { ParsedSearch, PlatformCtx, PlatformDef, QueryState, UrlPart } from '../types.js'
import { andTerms, stripAt, stripHash, words } from '../text.js'
import { encodeTokens, lit, minusExcludeTokens, part, tok, type Token } from '../urlParts.js'
import { hostIs, leftoverParams, pathSegments, tokenize, unquote } from '../parse.js'
