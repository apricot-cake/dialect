...
import { andTerms, stripHash, words } from '../text.js'
import { encodeTokens, lit, part, tok, type Token } from '../urlParts.js'
import { hostMatches, leftoverParams, pathSegments, tokenize } from '../parse.js'
