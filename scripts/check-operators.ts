...
const PROBES: Probe[] = [
  ...
  },
  {
    ...
    concept: 'excludeUser',
    label: '除外ユーザー',
    state: { excludeUser: 'foo' },
    token: '-from:',
  },
  { platform: 'x', concept: 'toUser', label: '宛先', state: { toUser: 'nhk' }, token: 'to:' },
  {
    platform: 'x',
    concept: 'mentionsUser',
    label: 'メンション',
    state: { mentionsUser: 'nhk' },
    token: '(@nhk)',
  },
  {
    platform: 'x',
  ...
  {
    platform: 'x',
    concept: 'excludeReplies',
    label: '返信除外',
    state: { excludeReplies: true },
    token: '-filter:replies',
  },
  {
    platform: 'x',
    concept: 'minLikes',
  ...
  },
  {
    ...
    token: 'f=top',
    tracked: false,
    note: '既定タブ(人気/話題)。公式・安定なので確認リスト対象外',
  },
  {
    platform: 'x',
    concept: 'keywordsOr',
  ...
  // 新パラメータ形式(author=/mentions=/domain=)へ移行(旧q内トークンはparseUrlが後方互換で読むのみ)
  {
    ...
    concept: 'fromUser',
    label: '送信者',
    state: { fromUser: 'nhk.bsky.social' },
    token: 'author=',
  },
  {
    platform: 'bluesky',
    concept: 'excludeUser',
    label: '除外送信者',
    state: { excludeUser: 'nhk.bsky.social' },
    token: 'excludeAuthor=',
  },
  {
    platform: 'bluesky',
    concept: 'mentionsUser',
    label: 'メンション先',
    state: { mentionsUser: 'nhk.bsky.social' },
    token: 'mentions=',
  },
  {
    platform: 'bluesky',
    concept: 'excludeMentions',
    label: '除外メンション先',
  ...
  },
  {
    ...
    concept: 'hashtagOr',
    label: 'ハッシュタグ(OR)',
    state: { hashtagOr: 'cat dog' },
    token: 'tag=',
  },
  {
    platform: 'bluesky',
    concept: 'excludeHashtag',
    label: 'ハッシュタグ除外',
    state: { excludeHashtag: 'cat' },
    token: 'excludeTag=',
  },
  {
    platform: 'bluesky',
  ...
  },
  {
    ...
    concept: 'resultType',
    label: '探す=チャンネル',
    state: { sort: 'auto', resultType: 'channel' },
    token: 'EgIQAg',
  },
  {
    platform: 'youtube',
    concept: 'resultType',
    label: '探す=ショート',
    state: { sort: 'auto', resultType: 'short' },
    token: 'EgIQCQ',
  },
  {
    platform: 'youtube',
    concept: 'resultType',
    label: '探す=再生リスト',
    state: { sort: 'auto', resultType: 'playlist' },
    token: 'EgIQAw',
  },
  {
    platform: 'youtube',
  ...
  },
  {
    ...
    token: 'sort=mylistCount',
  },
  {
    platform: 'niconico',
    concept: 'sortOrder',
    label: 'コメント日時順',
    state: { sort: 'commentDate' },
    token: 'sort=lastCommentTime',
  },
  {
    platform: 'niconico',
    concept: 'period',
  ...
  },
  {
    platform: 'niconico',
    concept: 'sortOrder',
    label: '探す=シリーズの並び順(作成日)',
    state: { resultType: 'series', sort: 'new' },
    token: 'sort=startTime',
  },
  {
    platform: 'niconico',
    concept: 'sortOrder',
    label: '探す=シリーズの並び順(登録動画数)',
    state: { resultType: 'series', sort: 'videoCount' },
    token: 'sort=videoCount',
  },
  {
    platform: 'niconico',
    concept: 'sortOrder',
    label: '探す=シリーズの並び順(動画追加日時)',
    state: { resultType: 'series', sort: 'videoAdded' },
    token: 'sort=lastAddedTime',
  },
  {
    platform: 'niconico',
    concept: 'sortOrder',
    label: '探す=マイリストの並び順(動画追加日時)',
    state: { resultType: 'playlist', sort: 'videoAdded' },
    token: 'sort=lastAddedTime',
  },
  {
    platform: 'niconico',
    concept: 'sortOrder',
    label: '探す=ユーザーの並び順(投稿動画数)',
    state: { resultType: 'people', sort: 'videoCount' },
    token: 'sort=videoCount',
  },
  {
    platform: 'niconico',
    concept: 'sortOrder',
    label: '探す=ユーザーの並び順(フォロワー数)',
    state: { resultType: 'people', sort: 'followerCount' },
    token: 'sort=followerCount',
  },
  {
    platform: 'niconico',
    concept: 'sortOrder',
    label: '探す=ユーザーの並び順(生放送番組数)',
    state: { resultType: 'people', sort: 'liveCount' },
    token: 'sort=liveCount',
  },
  ...
  },
  {
    ...
    label: 'タグ完全一致',
    state: { exactTag: true },
    token: 's_mode=s_tag_full',
  },
  {
    platform: 'pixiv',
    concept: 'tagTitleCaption',
    label: 'タグ・タイトル・キャプション',
    state: { tagTitleCaption: true },
    token: 's_mode=tag_tc',
  },
  {
    platform: 'pixiv',
    concept: 'pixivPopular',
    label: '人気の目安',
    state: { pixivPopular: '000users' },
    token: 'users入り',
    emit: '000users',
  },
  {
  ...
  },
  {
    ...
    concept: 'hashtag',
    label: 'タグ複数(AND)',
    state: { terms: [''], hashtag: 'photography sunset' },
    token: '#sunset',
  },
  {
    platform: 'tumblr',
  ...
  },
  {
    ...
    concept: 'exactPhrase',
    label: '完全一致',
    state: { exactPhrase: ['golden retriever puppy'] },
    token: '"golden retriever puppy"',
  },
  {
    platform: 'tumblr',
    concept: 'period',
  ...
  },
  {
    ...
    concept: 'exactPhrase',
    label: '完全一致',
    state: { exactPhrase: ['conectivitate la internet'] },
    token: '"conectivitate la internet"',
  },
  {
    platform: 'mastodon',
    concept: 'fromUser',
    label: '送信者',
    state: { fromUser: 'Gargron' },
    token: 'from:Gargron',
  },
  {
    platform: 'mastodon',
  ...
  },
  {
    ...
    concept: 'sortOrder',
    label: 'いいね順(コラム)',
    state: { resultType: 'article', sort: 'likes' },
    token: 'order=attention',
  },
  {
    platform: 'bilibili',
    concept: 'sortOrder',
    label: 'コメント数順(コラム)',
    state: { resultType: 'article', sort: 'comments' },
    token: 'order=scores',
  },
  {
    platform: 'bilibili',
  ...
  },
  {
    ...
    label: 'タイトルのみ',
    state: { titleOnly: true },
    token: 'keyword_type=title_only',
  },
  {
    platform: 'fantia',
    concept: 'fantiaCategory',
    label: 'カテゴリー',
    state: { fantiaCategory: 'illust' },
    token: 'category=illust',
  },
  {
    platform: 'fantia',
    concept: 'fantiaAudience',
    label: '対象読者(男性向け)',
    state: { fantiaAudience: 'male' },
    token: 'brand_type=0',
  },
  {
    platform: 'fantia',
  ...
  {
    platform: 'github',
    concept: 'pushedPeriod',
    label: '最終update日',
    state: { pushedSince: '2024-01-01' },
    token: 'pushed:',
  },
  {
    platform: 'github',
    concept: 'codeLicense',
    label: 'ライセンス（GitHub）',
    state: { codeLicense: 'mit' },
    token: 'license:',
  },
  {
    platform: 'github',
    concept: 'includeForks',
    label: 'フォークの扱い',
  ...
  {
    platform: 'github',
    concept: 'searchInName',
    label: '検索範囲: リポジトリ名',
    state: { searchInName: true },
    token: 'in:',
  },
  {
    platform: 'github',
    concept: 'searchInDescription',
    label: '検索範囲: 説明文',
  ...
  {
    platform: 'github',
    concept: 'searchInReadme',
    label: '検索範囲: README',
    state: { searchInReadme: true },
    token: 'in:',
  },
  {
    platform: 'github',
  ...
  },
  {
    ...
    label: '拡張子',
    state: { resultType: 'code', fileExtension: 'rb' },
    token: 'path:',
  },
  {
    platform: 'github',
    concept: 'filePath',
    label: 'パス',
    state: { resultType: 'code', filePath: 'src/lib' },
    token: 'path:',
  },
  {
    platform: 'github',
    concept: 'fileName',
    label: 'ファイル名',
    state: { resultType: 'code', fileName: 'app.rb' },
    token: 'path:',
  },
  {
    platform: 'github',
    concept: 'issueState',
    label: '状態',
    state: { resultType: 'issues', issueState: 'open' },
    token: 'state:',
  },
  {
    platform: 'github',
    concept: 'issueReason',
    label: 'クローズ理由',
    state: { resultType: 'issues', issueReason: 'not planned' },
    token: 'reason:',
  },
  {
    platform: 'github',
    concept: 'minComments',
    label: '最低コメント数',
    state: { resultType: 'issues', minComments: '5' },
    token: 'comments:',
  },
  {
    platform: 'github',
    concept: 'label',
    label: 'ラベル',
    state: { resultType: 'issues', label: 'bug' },
    token: 'label:',
  },
  {
    platform: 'github',
    concept: 'assignee',
    label: '担当者',
    state: { resultType: 'issues', assignee: 'octocat' },
    token: 'assignee:',
  },
  {
    platform: 'github',
    concept: 'mentionsUser',
    label: '宛先・メンション',
    state: { resultType: 'issues', mentionsUser: 'octocat' },
    token: 'mentions:',
  },
  {
    platform: 'github',
    concept: 'updatedPeriod',
    label: '最終更新日',
    state: { resultType: 'issues', updatedSince: '2024-01-01' },
    token: 'updated:',
  },
  {
    platform: 'github',
    concept: 'fullName',
    label: '表示名',
    state: { resultType: 'people', fullName: 'Grace Hopper' },
    token: 'fullname:',
  },
  {
    platform: 'github',
    concept: 'userLocation',
    label: '所在地',
    state: { resultType: 'people', userLocation: 'Tokyo' },
    token: 'location:',
  },
  {
    platform: 'github',
    concept: 'minFollowers',
    label: '最低フォロワー数',
    state: { resultType: 'people', minFollowers: '100' },
    token: 'followers:',
  },
  {
    platform: 'github',
    concept: 'minRepos',
    label: '最低公開リポジトリ数',
    state: { resultType: 'people', minRepos: '10' },
    token: 'repos:',
  },
  // ---- Qiita ----
  {
...
function coverageStatesFor(concept: ConceptId): QueryState[] {
  ...
  if (def.widget === 'sort')
    return SORT_OPTIONS.filter((o) => o.value !== 'auto').map((o) => mk({ sort: o.value }))
...
function sampleStates(): QueryState[] {
  ...
  for (const def of CONCEPT_DEFS) {
    ...
    if (def.widget === 'toggle') out.push({ ...BASE, [f]: true })
      ...
      for (const o of SORT_OPTIONS) out.push({ ...BASE, sort: o.value })
...
for (const platform of PLATFORMS) {
  ...
  if (!section) {
    fails.push({
      ...
      detail: `チェックリストに「${CHECKLIST_HEADING[platform.id]}」の節が見つからない`,
    })
    continue
  }
  lines.push(`\n## ${platform.name}`)
  for (const pr of probes) {
    ...
    if (!emitted) {
      ...
      fails.push({
        kind: 'self',
        platform: platform.id,
        detail: `${pr.label}: buildUrl 出力に "${emit}" が無い`,
      })
    } else if (!tracked) {
      icon = '⚪'
      ...
      fails.push({
        kind: 'drift',
        platform: platform.id,
        detail: `${pr.label} (${pr.concept}): "${pr.token}" がチェックリスト未収録`,
      })
    }
  ...
  for (const def of CONCEPT_DEFS) {
    ...
    if (!demonstrated) {
      if (SATISFIED_BY_DEFAULT.has(`${platform.id}::${concept}`)) {
        ...
        exemptLines.push(
          `  ⚪ ${platform.name.padEnd(14)} ${concept} (support=${level}) — 既定挙動で充足(URL差分なしを承知)`,
        )
        continue
      }
      silentLines.push(
  ...
  for (const state of samples) {
    ...
    for (const s of surfacesOf(url)) {
      ...
      if (!known.has(key) && !seen.has(key)) {
        seen.add(key)
        orphanLines.push(
          `  🟨 ${platform.name.padEnd(14)} 未登録の演算子面 "${s}" — PROBES に追加を`,
        )
