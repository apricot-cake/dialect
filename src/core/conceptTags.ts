...
export const CONCEPT_TAGS: Partial<Record<ConceptId, TagId[]>> = {
  ...
  semanticSearch: ['word'],
  minForks: ['reaction', 'popular'],
  minSizeKb: ['size', 'format'],
  pushedPeriod: ['time'],
  codeLicense: ['format'],
  includeForks: ['format'],
  visibility: ['format'],
  topic: ['tag', 'word'],
  searchInName: ['word', 'format'],
  searchInDescription: ['word', 'format'],
  searchInReadme: ['word', 'format'],
  archived: ['format'],
  mirror: ['format'],
  org: ['person', 'place'],
  fileExtension: ['format', 'word'],
  filePath: ['format', 'word'],
  fileName: ['format', 'word'],
  issueState: ['format'],
  issueReason: ['format'],
  minComments: ['reaction', 'popular'],
  label: ['tag', 'word'],
  assignee: ['person', 'target'],
  updatedPeriod: ['time'],
  fullName: ['person'],
  userLocation: ['place'],
  minFollowers: ['reaction', 'popular', 'person'],
  minRepos: ['reaction', 'popular'],
}
