...
export const CONCEPT_DEFS: ConceptDef[] = [
  ...
  { id: 'hashtagOr', field: 'hashtagOr', widget: 'chips', labelKey: 'concept.hashtagOr.label', helpKey: 'concept.hashtagOr.help', placeholderKey: 'concept.hashtagOr.placeholder' },
  { id: 'excludeHashtag', field: 'excludeHashtag', widget: 'chips', labelKey: 'concept.excludeHashtag.label', helpKey: 'concept.excludeHashtag.help', placeholderKey: 'concept.excludeHashtag.placeholder' },
  ...
  { id: 'videoOnly', field: 'videoOnly', widget: 'toggle', labelKey: 'concept.videoOnly.label', helpKey: 'concept.videoOnly.help' },
  { id: 'repliesOnly', field: 'repliesOnly', widget: 'toggle', labelKey: 'concept.repliesOnly.label', helpKey: 'concept.repliesOnly.help' },
  { id: 'followingOnly', field: 'followingOnly', widget: 'toggle', labelKey: 'concept.followingOnly.label', helpKey: 'concept.followingOnly.help' },
  ...
  { id: 'excludeMentions', field: 'excludeMentions', widget: 'plain', labelKey: 'concept.excludeMentions.label', helpKey: 'concept.excludeMentions.help', placeholderKey: 'concept.excludeMentions.placeholder' },
  ...
  { id: 'excludeDomain', field: 'excludeDomain', widget: 'plain', labelKey: 'concept.excludeDomain.label', helpKey: 'concept.excludeDomain.help', placeholderKey: 'concept.excludeDomain.placeholder' },
  { id: 'linkUrl', field: 'linkUrl', widget: 'plain', labelKey: 'concept.linkUrl.label', helpKey: 'concept.linkUrl.help', placeholderKey: 'concept.linkUrl.placeholder' },
  { id: 'excludeLinkUrl', field: 'excludeLinkUrl', widget: 'plain', labelKey: 'concept.excludeLinkUrl.label', helpKey: 'concept.excludeLinkUrl.help', placeholderKey: 'concept.excludeLinkUrl.placeholder' },
