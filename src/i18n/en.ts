...
export const en = {
  ...
  'concept.minForks.label': 'Minimum forks',
  'concept.minForks.placeholder': 'e.g. 10',
  'concept.minForks.help': 'Keeps only repositories forked at least this many times (GitHub only).',
  'concept.minSizeKb.label': 'Minimum size (KB)',
  'concept.minSizeKb.placeholder': 'e.g. 500',
  'concept.minSizeKb.help': 'Keeps only repositories at least this large, in KB (GitHub only).',
  'concept.pushedPeriod.label': 'Last pushed',
  'concept.pushedPeriod.help':
    'Keeps only repositories last pushed (updated) within this range (GitHub only; a separate date axis from the creation-date period).',
  'concept.codeLicense.label': 'License (SPDX)',
  'concept.codeLicense.none': 'Not specified',
  ...
  'concept.codeLicense.help': 'Keeps only repositories under the given license (GitHub only).',
  'concept.includeForks.label': 'Forks',
  'concept.includeForks.none': 'Exclude forks',
  'concept.includeForks.true': 'Include forks',
  'concept.includeForks.only': 'Forks only',
  'concept.includeForks.help':
    'Controls whether forked repositories are included in results (GitHub only; the default excludes forks).',
  'concept.visibility.label': 'Visibility',
  'concept.visibility.none': 'Not specified',
  'concept.visibility.public': 'Public only',
  'concept.visibility.private': 'Private only',
  'concept.visibility.help':
    'Keeps only public or private repositories (GitHub only; private results are limited to what you can access).',
  'concept.topic.label': 'Topic',
  'concept.topic.placeholder': 'e.g. react',
  'concept.topic.help':
    'Keeps only repositories tagged with the given topic (GitHub only). Space-separate multiple topics to require all of them.',
  'concept.searchInName.label': 'Search in: repository name',
  'concept.searchInName.help':
    'Includes the repository name in the search scope (GitHub only). If no search-in option is chosen, name and description are searched by default.',
  'concept.searchInDescription.label': 'Search in: description',
  'concept.searchInDescription.help':
    'Includes the repository description in the search scope (GitHub only).',
  'concept.searchInReadme.label': 'Search in: README',
  'concept.searchInReadme.help': 'Includes the README contents in the search scope (GitHub only).',
  'concept.archived.label': 'Archived',
  'concept.archived.none': 'Not specified',
  'concept.archived.true': 'Archived only',
  'concept.archived.false': 'Non-archived only',
  'concept.archived.help':
    'Keeps only repositories that are (or are not) archived, i.e. read-only (GitHub only).',
  'concept.mirror.label': 'Mirror repository',
  'concept.mirror.none': 'Not specified',
  'concept.mirror.true': 'Mirrors only',
  'concept.mirror.false': 'Non-mirrors only',
  'concept.mirror.help':
    'Keeps only repositories that are (or are not) mirrors of another source (GitHub only).',
  'concept.org.label': 'Organization',
  'concept.org.placeholder': 'e.g. github',
  'concept.org.help': 'Keeps only results owned by the given organization (GitHub only).',
  'concept.fileExtension.label': 'Extension',
  'concept.fileExtension.placeholder': 'e.g. rb',
  'concept.fileExtension.help':
    'Keeps only files with the given extension (GitHub code search only).',
  'concept.filePath.label': 'Path',
  'concept.filePath.placeholder': 'e.g. src/lib',
  'concept.filePath.help':
    'Keeps only files matching the given path (glob patterns work too) (GitHub code search only).',
  'concept.fileName.label': 'File name',
  'concept.fileName.placeholder': 'e.g. app.rb',
  'concept.fileName.help': 'Keeps only files with the given name (GitHub code search only).',
  'concept.issueState.label': 'State',
  'concept.issueState.none': 'Not specified',
  'concept.issueState.open': 'Open',
  'concept.issueState.closed': 'Closed',
  'concept.issueState.help': 'Keeps only issues/pull requests in the given state (GitHub only).',
  'concept.issueReason.label': 'Close reason',
  'concept.issueReason.none': 'Not specified',
  'concept.issueReason.completed': 'Completed',
  'concept.issueReason.notPlanned': 'Not planned',
  'concept.issueReason.reopened': 'Reopened',
  'concept.issueReason.help': 'Keeps only issues closed for the given reason (GitHub only).',
  'concept.minComments.label': 'Minimum comments',
  'concept.minComments.placeholder': 'e.g. 5',
  'concept.minComments.help':
    'Keeps only issues/pull requests with at least this many comments (GitHub only).',
  'concept.label.label': 'Label',
  'concept.label.placeholder': 'e.g. bug',
  'concept.label.help':
    'Keeps only issues/pull requests carrying all the given labels (GitHub only). Labels containing spaces are not supported.',
  'concept.assignee.label': 'Assignee',
  'concept.assignee.placeholder': 'e.g. octocat',
  'concept.assignee.help':
    'Keeps only issues/pull requests assigned to all the given users (GitHub only).',
  'concept.updatedPeriod.label': 'Last updated',
  'concept.updatedPeriod.help':
    'Keeps only issues/pull requests last updated within this range (GitHub only).',
  'concept.fullName.label': 'Full name',
  'concept.fullName.placeholder': 'e.g. Grace Hopper',
  'concept.fullName.help': 'Keeps only users with the given display (full) name (GitHub only).',
  'concept.userLocation.label': 'Location',
  'concept.userLocation.placeholder': 'e.g. Tokyo',
  'concept.userLocation.help': 'Keeps only users with the given location set (GitHub only).',
  'concept.minFollowers.label': 'Minimum followers',
  'concept.minFollowers.placeholder': 'e.g. 100',
  'concept.minFollowers.help': 'Keeps only users with at least this many followers (GitHub only).',
  'concept.minRepos.label': 'Minimum public repos',
  'concept.minRepos.placeholder': 'e.g. 10',
  'concept.minRepos.help':
    'Keeps only users with at least this many public repositories (GitHub only).',
  ...
  'note.github.repoCodeScopeOnly': 'Only works for repository and code search.',
  'note.github.codeScopeOnly': 'Only works for code search.',
  'note.github.issueScopeOnly': 'Only works for issue and pull request search.',
  'note.github.userScopeOnly': 'Only works for user search.',
  'note.github.codeLoginRequired': 'Viewing code search results requires signing in to GitHub.',
  ...
  'conflict.pushedPeriodReversed':
    'The last-pushed start date is after the end date. No search is possible for this range.',
  'conflict.updatedPeriodReversed':
    'The last-updated start date is after the end date. No search is possible for this range.',
