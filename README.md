...
| GitHub          | `github.com/search`                     | Not required | Rich (owner/org, language, license, stars/forks/size, multiple dates, fork/visibility/archived/mirror filters, topic, code path, issue state/reason/labels/assignee, user profile fields, result type (repositories/code/issues/pull requests/discussions/users)) |
