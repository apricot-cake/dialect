import type { ConceptId, InstanceHosts, PlatformId, QueryState } from '@apricot-cake/dialect-core'
import { paramsToQuery, stateToParams, PLATFORMS } from '@apricot-cake/dialect-core'
