    ...
    <div className="fixed inset-0 overflow-hidden bg-bg text-fg">
      ...
      >
        <ConditionsArea
          ...
          shareUrl={
            canClear ? permalinkUrl(`${location.origin}${location.pathname}`, query) : undefined
          }
      ...
      <SaveSearchDialog
        ...
        defaultName={saveTarget ? searchSummary(getLang(), saveTarget) : ''}
        onSave={handleSave}
      />
      <SavedListDialog
        open={savedListOpen}
      ...
      <QrDialog
        ...
        url={canClear ? permalinkUrl(`${location.origin}${location.pathname}`, query) : undefined}
      />
      {promoteSuggestion && (
        <div
